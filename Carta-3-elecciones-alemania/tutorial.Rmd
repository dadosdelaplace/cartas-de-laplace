...
datos_brutos <-
    read_delim(file = "./DATOS/2021.csv", delim = ";")
```
...
He repetido este proceso para tener los datos de las elecciones de 2021, 2017, 2013 y 2009, de forma podemos cargar cada archivo y guardarlo todo en una lista `datos_por_fecha`.
...
for (i in 1:length(fechas)) {
  ...
  datos_por_fecha[[fechas[[i]]]] <-
    read_csv(file = glue("./DATOS/EXPORTADO/datos_depurados_{elecciones}.csv"))
